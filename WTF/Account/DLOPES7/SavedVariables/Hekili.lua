...
{
["enabled"] = true,
["criteria"] = "! debuff.skyreach_exhaustion.up & combo_strike",
["action"] = "tiger_palm",
["cycle_targets"] = 1,
},
{
...
{
["enabled"] = true,
["criteria"] = "! debuff.skyreach_exhaustion.up & combo_strike & active_enemies = 5",
["action"] = "tiger_palm",
["cycle_targets"] = 1,
},
{
...
{
["enabled"] = true,
["criteria"] = "! buff.pressure_point.up & debuff.skyreach_exhaustion.remains < 55 & ( debuff.fae_exposure_damage.remains > 2 || cooldown.jadefire_stomp.remains )",
["action"] = "fists_of_fury",
},
{
["enabled"] = true,
...
["action"] = "jadefire_stomp",
["cycle_targets"] = 1,
["description"] = "Prioritize Jadefire Stomp if playing with Jadefire Harmony",
["criteria"] = "combo_strike & talent.jadefire_harmony.enabled & debuff.fae_exposure_damage.remains < 1",
},
{
["enabled"] = true,
...
{
["enabled"] = true,
["description"] = "Use Chi Burst to reset Jadefire Stomp",
["criteria"] = "talent.jadefire_stomp.enabled & cooldown.jadefire_stomp.remains & ( chi.max - chi >= 1 & active_enemies = 1 || chi.max - chi >= 2 & active_enemies >= 2 ) & ! talent.jadefire_harmony.enabled",
["action"] = "chi_burst",
},
{
["enabled"] = true,
...
["strict"] = 1,
["criteria"] = "buff.serenity.up & ( ( buff.bloodlust.up & ( buff.invokers_delight.up || buff.power_infusion.up ) ) || buff.invokers_delight.up & buff.power_infusion.up ) & active_enemies > 4",
["list_name"] = "serenity_aoelust",
},
{
["enabled"] = true,
["action"] = "call_action_list",
...
["value"] = "1",
["criteria"] = "raid & ( equipped.neltharions_call_to_dominance || equipped.ashes_of_the_embersoul || equipped.mirror_of_fractured_tomorrows || equipped.witherbarks_branch )",
["default"] = "0",
},
{
["action"] = "summon_white_tiger_statue",
...
{
["enabled"] = true,
["criteria"] = "! talent.jadefire_stomp.enabled",
["action"] = "chi_burst",
},
{
["action"] = "chi_wave",
...
{
["enabled"] = true,
["criteria"] = "! prev_gcd.1.elysian_decree",
...
{
["enabled"] = true,
["criteria"] = "fury >= 40 & ( soul_fragments <= 1 || soul_fragments >= 4 ) & ! prev_gcd.1.elysian_decree",
["action"] = "elysian_decree",
},
{
["action"] = "fel_devastation",
...
{
["enabled"] = true,
["criteria"] = "fury >= 40 & ! prev_gcd.1.elysian_decree",
["action"] = "elysian_decree",
},
{
["enabled"] = true,
...
["value_else"] = "( variable.small_aoe & soul_fragments >= 4 ) || ( variable.big_aoe & soul_fragments >= 3 )",
...
{
["enabled"] = true,
["criteria"] = "buff.wild_imps.stack > 1 & ( buff.demonic_core.stack < 3 || buff.demonic_core.remains < gcd.max * 3 )",
["action"] = "power_siphon",
},
{
["enabled"] = true,
...
["criteria"] = "! buff.fire_elemental.up & ( ! talent.primal_elementalist.enabled || ! buff.lesser_fire_elemental.up )",
},
{
["enabled"] = true,
["action"] = "storm_elemental",
["description"] = "Keep your cooldowns rolling.",
["criteria"] = "! buff.storm_elemental.up & ( ! talent.primal_elementalist.enabled || ! buff.lesser_storm_elemental.up )",
},
{
["enabled"] = true,
["action"] = "totemic_recall",
["description"] = "Reset LMT CD as early as possible.",
["criteria"] = "cooldown.liquid_magma_totem.remains > 45 & ( active_enemies > 1 & ( spell_targets.chain_lightning > 1 || spell_targets.lava_beam > 1 ) )",
},
{
["enabled"] = true,
["action"] = "liquid_magma_totem",
["description"] = "Keep your cooldowns rolling.",
["criteria"] = "active_dot.flame_shock = 0 || dot.flame_shock.remains < 6 || active_enemies > 1 & ( spell_targets.chain_lightning > 1 || spell_targets.lava_beam > 1 )",
},
{
["enabled"] = true,
...
["enabled"] = true,
["action"] = "flame_shock",
["criteria"] = "active_enemies = 1 & refreshable & ( dot.flame_shock.remains < cooldown.primordial_wave.remains || ! talent.primordial_wave.enabled ) & ! buff.surge_of_power.up & ( ! buff.master_of_the_elements.up || ( ! buff.stormkeeper.up & ( talent.elemental_blast.enabled & maelstrom < 90 - 10 * talent.eye_of_the_storm.enabled || maelstrom < 60 - 5 * talent.eye_of_the_storm.enabled ) ) )",
["cycle_targets"] = 1,
},
{
["enabled"] = true,
...
["action"] = "flame_shock",
["cycle_targets"] = 1,
["criteria"] = "active_enemies > 1 & ( spell_targets.chain_lightning > 1 || spell_targets.lava_beam > 1 ) & refreshable & ( talent.deeply_rooted_elements.enabled || talent.ascendance.enabled || talent.primordial_wave.enabled || talent.searing_flames.enabled || talent.magma_chamber.enabled ) & ( buff.surge_of_power.up & ! buff.stormkeeper.up & ! cooldown.stormkeeper.remains = 0 || ! talent.surge_of_power.enabled )",
["description"] = "Spread Flame Shock to multiple targets only if talents were selected that benefit from it.",
},
{
["enabled"] = true,
["action"] = "stormkeeper",
["description"] = "{SoP builds} Use Stormkeeper if you already got Surge of Power buff rolling.",
["criteria"] = "! buff.ascendance.up & ! buff.stormkeeper.up & buff.surge_of_power.up",
},
{
["enabled"] = true,
["criteria"] = "! buff.ascendance.up & ! buff.stormkeeper.up & ( ! talent.surge_of_power.enabled || ! talent.elemental_blast.enabled )",
["action"] = "stormkeeper",
},
{
["enabled"] = true,
...
["criteria"] = "cooldown_react & buff.lava_surge.up & ( talent.deeply_rooted_elements.enabled || ! talent.master_of_the_elements.enabled || ! talent.elemental_blast.enabled )",
},
{
["enabled"] = true,
["action"] = "lava_burst",
["cycle_targets"] = 1,
["criteria"] = "dot.flame_shock.remains > 2 & buff.ascendance.up & ! talent.elemental_blast.enabled",
...
["action"] = "lava_burst",
["cycle_targets"] = 1,
["criteria"] = "dot.flame_shock.remains > 2 & talent.master_of_the_elements.enabled & ! buff.master_of_the_elements.up & ! talent.lightning_rod.enabled",
...
["criteria"] = "talent.master_of_the_elements.enabled & ! buff.master_of_the_elements.up & ( maelstrom >= 80 || maelstrom >= 55 & ! talent.elemental_blast.enabled ) & talent.swelling_maelstrom.enabled & maelstrom <= 130",
},
{
["enabled"] = true,
["action"] = "earthquake",
["description"] = "Use the talents you selected. Additionally Elemental Blast is stronger than EoGS. In this case don't use Earthquake on single target.",
...
["criteria"] = "buff.icefury_dmg.up & talent.flux_melting.enabled & ! buff.flux_melting.up",
},
{
["enabled"] = true,
["action"] = "lava_burst",
["cycle_targets"] = 1,
["criteria"] = "dot.flame_shock.remains > 2 & talent.echo_of_the_elements.enabled || ! talent.elemental_blast.enabled || ! talent.master_of_the_elements.enabled || buff.stormkeeper.up",
...
["criteria"] = "buff.power_of_the_maelstrom.up & active_enemies > 1 & ( spell_targets.chain_lightning > 1 || spell_targets.lava_beam > 1 )",
},
{
["enabled"] = true,
["action"] = "lightning_bolt",
...
["action"] = "flame_shock",
["cycle_targets"] = 1,
["criteria"] = "refreshable & buff.surge_of_power.up & talent.lightning_rod.enabled & dot.flame_shock.remains < target.time_to_die - 16 & active_enemies < 5",
["description"] = "Spread Flame Shock using Surge of Power on up to 4 for Lightning builds.",
},
{
["enabled"] = true,
["action"] = "flame_shock",
...
["enabled"] = true,
["action"] = "earthquake",
["description"] = "{T31 fire} Earthquake is still good with Mote and either 10 Magma Chamber stacks on 6+ targets or 9+ targets.",
["criteria"] = "buff.master_of_the_elements.up & ( buff.magma_chamber.stack = 10 & active_enemies >= 6 || talent.splintered_elements.enabled & active_enemies >= 9 || talent.mountains_will_fall.enabled & active_enemies >= 9 ) & ( ! talent.lightning_rod.enabled & set_bonus.tier31_4pc )",
},
{
["enabled"] = true,
["action"] = "lava_beam",
...
["action"] = "lava_burst",
["cycle_targets"] = 1,
["criteria"] = "dot.flame_shock.remains & active_enemies = 3 & talent.master_of_the_elements.enabled",
...
["action"] = "lava_burst",
["cycle_targets"] = 1,
["criteria"] = "dot.flame_shock.remains & buff.lava_surge.up & talent.deeply_rooted_elements.enabled",
...
["criteria"] = "talent.fusion_of_elements.enabled & talent.echoes_of_great_sundering.enabled",
},
{
["enabled"] = true,
...
["date"] = 20240714,
["spec"] = 264,
["desc"] = "2024-07-14:  Remove Primordial Wave.\n\n2023-03-21:  Add Healing Rain (Acid Rain) and Stormkeeper to DPS priority.",
["lists"] = {
["default"] = {
{
["enabled"] = true,
